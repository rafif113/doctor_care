						...
						<tbody>
							<?php foreach ($pembayaran as $data) { ?>
								...
								<tr>
									...
									<?php	} else { ?>
										<td class="text-text-center">
											<span class="badge badge-warning text-white"> Belum Terbayar </span>
										</td>
									<?php	} ?>
									<td class="text-center">
										<?php if ($data->status_bayar == "Belum dibayar") { ?>
											...
											<?php	} else { ?>
												<button disabled class="btn btn-warning btn-sm">Terima Pembayaran
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit">
														<path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
														<path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
													</svg>
										...
										<?php	} else { ?>
											...
											<?php	} else { ?>
												<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#setujuKonsultasi<?= $data->id_konsultasi ?>"> Setujui Pembayaran
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
														<polyline points="20 6 9 17 4 12"></polyline>
													</svg>
												</button>
