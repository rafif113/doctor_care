							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input id="timeFlatpickr" name="jam_mulai" class="form-control flatpickr flatpickr-input active text-black" type="text" placeholder="Select Date..">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label for="website2">Jam Berakhir</label>
										<input id="timeFlatpickr2" name="jam_berakhir" class="form-control flatpickr flatpickr-input active text-black" type="text" placeholder="Select Date..">
									</div>
								</div>
							</div>
						</div>
						...
						<tbody>
							<?php foreach ($jadwal as $data) { ?>
								<tr>
									...
									<td class="text-center"><button class="btn btn-primary btn-sm">Edit Jadwal <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit">
