			...
			<div class="form-form-wrap">
				<div class="form-container">
					<div class="form-content">
						...
						<p class="signup-link register">Sudah mempunyai akun? <a href="<?= base_url('dokter/auth') ?>">Log in</a></p>
						<form class="text-left" action="<?= base_url('dokter/auth/proses_registrasi') ?>" method="POST">
							<div class="form">
								...
								<div id="username-field" class="field-wrapper input">
									...
									<input name="nama_dokter" type="text" class="form-control" placeholder="Nama Lengkap" value="<?php echo set_value('nama_dokter') ?>">
