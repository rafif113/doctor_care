...
<head>
	...
	<title>Dokter | Dokter Care</title>
...
<body>
		...
		<header class="header navbar navbar-expand-sm">
			...
			<ul class="navbar-item theme-brand flex-row  text-center">
				...
				<li class="nav-item theme-text">
					<a href="<?= base_url('dokter/') ?>" class="nav-link"> DOKTORCARE </a>
				</li>
			</ul>

			<ul class="navbar-item flex-row ml-md-auto">
				<li>
					<h6 class="mt-3 text-white">Selamat Datang <?= $this->session->nama_dokter; ?></h6>
				</li>
					...
					<div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
						<div class="">
							<div class="dropdown-item">
								<a class="" href="<?= base_url('dokter/profile') ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user">
										<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
										<circle cx="12" cy="7" r="4"></circle>
									</svg> Profile</a>
							</div>
							<div class="dropdown-item">
								<a class="" href="<?= base_url('dokter/auth/logout') ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out">
	...
	<div class="main-container" id="container">
		...
		<?php $this->load->view('dokter/layouts/sidebar'); ?>
