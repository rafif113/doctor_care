...
<head>
	...
	<title>Admin apotek | CORK - Multipurpose Bootstrap Dashboard Template </title>
			...
			<div class="form-form-wrap">
				<div class="form-container">
					<div class="form-content">
						...
						<h1 class="">Sign In Admin Apotek</h1>
						...
						<form class="text-left" action="<?= base_url('apotek/auth/proses_login') ?>" method="POST">
							<div class="form">
								...
								<p class="signup-link">Not registered ? <a href="<?= base_url('apotek/auth/registrasi') ?>">Create an account</a></p>
