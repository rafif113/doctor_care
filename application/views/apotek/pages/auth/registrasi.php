...
<head>
	...
	<title>Register Admin APotek | CORK - Multipurpose Bootstrap Dashboard Template </title>
			...
			<div class="form-form-wrap">
				<div class="form-container">
					<div class="form-content">
						...
						<h1 class="">Register Admin Apotek</h1>
						<p class="signup-link register">Already have an account? <a href="<?= base_url('apotek/auth') ?>">Log in</a></p>
